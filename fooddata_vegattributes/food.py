...
class Food:
  ...
  """
    ...
    def ingredient_code(self) -> int:
        ...
        Legacy.
        """
        if self.food_code is not None:
            return self.food_code
        elif self.ndb_number is not None:
            return self.ndb_number
        else:
            raise ValueError("invalid food with neither Food Code nor NDB Number")
    ...
    def from_fdc_food_dict(cls, d: FoodDataDict) -> "Food":
        ...
        if "foodCode" in d:
            ...
            raise ValueError("invalid food data dict with neither foodCode nor ndbNumber")
    ...
    def from_fdc_survey_food_dict(cls, d: SurveyFoodDataDict) -> "Food":
        return cls(
            **cls._kwargs_from_fdc_common_food_dict(d),
            ...
            fdc_category_description=(d["wweiaFoodCategory"]["wweiaFoodCategoryDescription"]),
        )
