...
default_dir_relative_paths = DirRelativePaths(
    ...
    compressed_indexed_fooddata_json=Path(default_filenames.compressed_indexed_fooddata_json),
    reference_samples_csv=Path(default_filenames.reference_samples_csv),
    generated_vegattributes_json=Path(default_filenames.generated_vegattributes_json),
)
...
class CombinedPath:
    ...
    def __get__(self, obj: AbstractDirPaths, objtype: Type[AbstractDirPaths] = None) -> Path:
