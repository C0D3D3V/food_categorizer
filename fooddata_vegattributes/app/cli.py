...
from .list_by_veg_and_fdc_categories import main as list_by_veg_and_fdc_categories_main
...
def list_by_veg_and_fdc_categories(fdc_category_description: str, veg_category: str):
...
def main():
    ...
    annotate_ref_parser = subparsers.add_parser("annotate-ref", help="annotate reference data")
    ...
    list_by_categories_parser = subparsers.add_parser(
        "list-by-veg-and-fdc-categories", help="list foods by veg and FDC categories"
    )
    list_by_categories_parser.set_defaults(func=list_by_veg_and_fdc_categories)
    list_by_categories_parser.add_argument("--fdc-category-description", required=True)
