...
class CachingZippedIndexableLinkableBytesStore(ZippedIndexableLinkableBytesStore):
    def __init__(self, zipfile: ZipFile):
        ...
        self._data_index_values_is_complete: Dict[str, bool] = defaultdict(lambda: False)
    ...
    def put_entries(self, index_name: str, index_values_and_data: Iterable[Tuple[str, bytes]]):
        ...
        self._data_index_values[index_name].update(k for k, v in index_values_and_data)
